...
ap143_mtdlayout_8M=mtdparts=spi0.0:256k(u-boot),64k(u-boot-env),6336k(rootfs),1472k(kernel),64k(art),7744k@0x50000(firmware)
ap143_mtdlayout_16M=mtdparts=spi0.0:256k(u-boot),64k(u-boot-env),14528k(rootfs),1472k(kernel),64k(art),16000k@0x50000(firmware)
